...
function buildDispatch() {
  return {
    ...
    set_working_folders: workspace.handleSetWorkingFolders,
    get_tool_allows: workspace.handleGetToolAllows,
    add_tool_allow: workspace.handleAddToolAllow,
    remove_tool_allow: workspace.handleRemoveToolAllow,
    get_working_folders: workspace.handleGetWorkingFolders,
