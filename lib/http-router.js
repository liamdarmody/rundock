  ...
  // until the user clicks Allow or Deny (or the 120s timeout fires).
    ...
    req.on('end', () => {
      try {
        ...
        // crossingCovered (lib/workspace/boundary.js) is PM-5's decision: a
        // sensitive crossing is covered only by its own narrow grant, never
        // by a standing grant over the wider sensitive root it sits inside.
