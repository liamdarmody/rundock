...
//
// THE NULL IS A SHORT-CIRCUIT AND NOT A DECISION, said here because it reads
// like one. A process with no home at all reaches the same 'no-transcript' by
// either route: return the joined relative path instead and the directory scan
// below fails on it, which is what the test 'a process with no home at all
// cannot find a transcript' asserts. So a mutation of this line turns nothing
// red, and that is this line saving a pointless filesystem call rather than
// the test being weak.
