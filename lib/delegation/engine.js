...
function handleDelegation(msg, processes) {
  ...
  // below). A malformed or expired id is a non-empty string that fails that
  // check, so the delegate gets a FRESH thread while `!priorSessionId` says it
  // is returning. It was then handed "since your last turn" over a slice of a
