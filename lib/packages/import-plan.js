...
// will read them back after apply writes them: readNormalisedFile normalises
// CRLF to LF before parsing, and that function is file-bound, so its exact
// transform is replicated here for in-memory text. The CRLF round-trip test
// pins this reading against the file-based one, so they cannot drift apart
// silently.
