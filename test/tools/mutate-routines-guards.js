...
const MUTATIONS = [
  ...
  [APP, 'the routines panel is one the router hides before revealing another',
    "['team','conversations','skills','files','settings','routines','pins','map']",
    "['team','conversations','skills','files','settings','pins','map']"],
  [APP, 'the routines panel is one showView knows how to reveal',
    "'settings','routine-editor','routines','run-detail','map']",
    "'settings','routine-editor','run-detail','map']"],
