...
const MUTATIONS = [
  ...
  [APP, 'the arriving roster redraws the list',
    'renderOrgChart(); renderRoutines(); updateRoutineFailureBadge();',
    'renderOrgChart(); updateRoutineFailureBadge();'],
  ...
  [VIEW, 'the header reads the scope the view actually holds',
