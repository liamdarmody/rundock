...
const ENUMERATIONS = [
  ...
  { file: 'test/unit/map-view.test.js', extraction: 'script tags out of index.html, and the search_index arm cut out of app.js', failLoudBy: 'count', where: 'every script the load-order test names is asserted found before its position is compared, and the cut arm refuses when the case or the arm is missing and is then run against both states', anchor: 'app.js no longer carries the search_index arm' },
