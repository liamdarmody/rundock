...
// recorded.
const ENUMERATIONS = [
  { file: 'test/unit/approve-once.test.js', extraction: "the client's getGuide declaration and its body, out of app.js", failLoudBy: 'count', where: 'the declaration match is asserted found, so a pattern that stops matching fails rather than skipping, and the extracted body is run against a specimen team and must resolve the platform agent carrying an id', anchor: "resolved.id, 'agent-doc-1'" },
