...
- **The Files sidebar creates files and keeps your place:** a plus button and right-click menu create notes, boards, and folders and reveal a file in the OS file manager, each row and tree entry carrying an icon for its type. The file you have open stays open when you switch views and comes back, and it is revealed and highlighted in the tree so you always see where it lives.
