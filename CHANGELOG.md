...
- **A conversation with several agents now reads like a conversation.** Agents handed work to each other in silence: the thread jumped to a new name with nothing saying who was taking over or why, and the brief they had written for each other was never shown to you at all. Now whoever is handing over says what they are passing on and to whom, in their own words, at the moment it happens. Whoever picks it up is told what they walked into, whether they are joining for the first time or coming back, so they stop repeating work that is already done. An agent arriving is announced once; an agent already in the conversation simply speaks, because the name on the message says who it is. Alongside that: a specialist can finish its part without ending the whole request, each agent's work appears in its own bubble rather than inside the previous agent's, and a handover that was in flight when you quit the app still works when you come back.
